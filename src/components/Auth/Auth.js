...
const Auth = (props) => {
    ...
    const loginToggle = (event) => {
        //Takes in an event so we can stop the page from reloading on the form submission
...
- the onChange handler takes in an anonymous function that will set the state of our variables top what we type in the input
